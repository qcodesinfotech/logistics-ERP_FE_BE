...
export async function ensureDriverTablesSchema() {
  ...
  try {
    await db.execute(`
      ...
      ALTER TABLE "dispatch_truck_assignments" ADD COLUMN IF NOT EXISTS "loading_start_time" text;
      ...
      ALTER TABLE "dispatch_sheets" ADD COLUMN IF NOT EXISTS "client_id" varchar;
